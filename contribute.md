...
Each GTFO binary is defined in a file in the [`_hacksudoCTF/`] folder named as `<binary name>.md`, such file consists only of a [YAML] front matter which describes the binary and its functions.
...
Feel free to use any file in the [`_hacksudoCTF/`] folder as an example.
...
[YAML]: https://yaml.org/
[`_hacksudoCTF/`]: https://github.com/hacksudoCTF/hacksudoCTF.github.io/tree/master/_hacksudoCTF
[`_data/functions.yml`]: https://github.com/hacksudoCTF/hacksudoCTF.github.io/blob/master/_data/functions.yml
